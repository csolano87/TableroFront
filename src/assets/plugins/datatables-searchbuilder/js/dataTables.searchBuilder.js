(function () {
  ...
  (function (factory) {
    ...
    $.extend(DateTime.prototype, {
      ...
      _writeOutput: function (focus) {
        ...
        var out = dateLib
          ? dateLib
              .utc(date, undefined$1, this.c.locale, this.c.strict)
  ...
  var Criteria = /** @class */ (function () {
    function Criteria(table, opts, topGroup, index, depth) {
      ...
      this.dom = {
        buttons: $("<div/>").addClass(this.classes.buttonContainer),
        condition: $("<select disabled/>")
          .addClass(this.classes.condition)
          .addClass(this.classes.dropDown)
          .addClass(this.classes.italic)
          .attr("autocomplete", "hacking"),
        conditionTitle: $('<option value="" disabled selected hidden/>').text(
        ...
        data: $("<select/>")
          ...
          .addClass(this.classes.dropDown)
          .addClass(this.classes.italic),
        dataTitle: $('<option value="" disabled selected hidden/>').text(
        ...
        delete: $("<button>&times</button>")
          ...
          .attr(
            "title",
            this.s.dt.i18n("searchBuilder.deleteTitle", i18n.deleteTitle),
          )
          .attr("type", "button"),
        left: $("<button><</button>")
        ...
        valueTitle: $('<option value="--valueTitle--" selected/>').text(
    ...
    Criteria.prototype.search = function (rowData, rowIdx) {
      ...
      if (this.s.condition !== undefined && condition !== undefined) {
        ...
        if (
          ...
          rowData[this.s.dataIdx] = rowData[this.s.dataIdx].replace(
            this.s.dt.settings()[0].oLanguage.sDecimal,
            ".",
          );
        }
      ...
      if (
        ...
        for (var i = 0; i < this.s.value.length; i++) {
          if (this.s.value[i].indexOf(".") !== -1) {
            value[i] = this.s.value[i].replace(
              ".",
              this.s.dt.settings()[0].oLanguage.sDecimal,
            );
          }
    ...
    Criteria.prototype.setListeners = function () {
      ...
      $(this.dom.condition)
        ...
        .on("input change", function () {
          ...
          var condDisp = $(_this.dom.condition)
            .children("option:selected")
            .val();
          // Find the condition that has been selected and store it internally
          for (
            var _i = 0, _a = Object.keys(_this.s.conditions);
            _i < _a.length;
            _i++
          ) {
            var cond = _a[_i];
          ...
          for (var _b = 0, _c = _this.dom.value; _b < _c.length; _b++) {
            ...
            if (
              _this.s.filled &&
              $(_this.dom.container).has(val).length !== 0
            ) {
              _this.s.filled = false;
              _this.s.dt.draw();
              _this.setListeners();
      ...
      if (this.s.dataPoints.length === 0) {
        this.s.dt.columns().every(function (index) {
          ...
          if (
            ...
            if (!found) {
              var opt = {
                text: _this.s.dt.settings()[0].aoColumns[index].sTitle,
                index: index,
              };
      ...
      // Otherwise we can just load them in
        ...
        var _loop_1 = function (data) {
          this_1.s.dt.columns().every(function (index) {
            if (
              _this.s.dt.settings()[0].aoColumns[index].sTitle === data.text
            ) {
              data.index = index;
            }
          });
      ...
      for (var _i = 0, el_1 = el; _i < el_1.length; _i++) {
        ...
        if (
          ...
          $(element).children("option:selected")[0] ===
            $(element).children("option:hidden")[0]
        ) {
          allFilled = false;
        }
      }
    ...
    Criteria.updateListener = function (that, el) {
      ...
      for (var i = 0; i < that.s.value.length; i++) {
        ...
        // Otherwise replace the decimal place character for i18n
          ...
          that.s.value[i] = that.s.value[i].replace(
    ...
    Criteria.momentDateConditions = {
      "=": {
        conditionName: function (dt, i18n) {
          return dt.i18n(
            "searchBuilder.conditions.moment.equals",
            i18n.conditions.moment.equals,
          );
        },
        init: Criteria.initDate,
        inputValue: Criteria.inputValueInput,
        ...
        search: function (value, comparison, that) {
          return (
            moment(value, that.s.momentFormat).valueOf() ===
            moment(comparison[0], that.s.momentFormat).valueOf()
          );
        },
      },
      "!=": {
        conditionName: function (dt, i18n) {
          return dt.i18n(
            "searchBuilder.conditions.moment.not",
            i18n.conditions.moment.not,
          );
        },
        init: Criteria.initDate,
        inputValue: Criteria.inputValueInput,
      ...
      "<": {
        conditionName: function (dt, i18n) {
          return dt.i18n(
            "searchBuilder.conditions.moment.before",
            i18n.conditions.moment.before,
          );
        },
        init: Criteria.initDate,
        inputValue: Criteria.inputValueInput,
      ...
      ">": {
        conditionName: function (dt, i18n) {
          return dt.i18n(
            "searchBuilder.conditions.moment.after",
            i18n.conditions.moment.after,
          );
        },
        init: Criteria.initDate,
        inputValue: Criteria.inputValueInput,
      ...
      between: {
        conditionName: function (dt, i18n) {
          return dt.i18n(
            "searchBuilder.conditions.moment.between",
            i18n.conditions.moment.between,
          );
        },
        init: Criteria.init2Date,
        inputValue: Criteria.inputValueInput,
      ...
      "!between": {
        conditionName: function (dt, i18n) {
          return dt.i18n(
            "searchBuilder.conditions.moment.notBetween",
            i18n.conditions.moment.notBetween,
          );
        },
        init: Criteria.init2Date,
        inputValue: Criteria.inputValueInput,
      ...
      null: {
        conditionName: function (dt, i18n) {
          return dt.i18n(
            "searchBuilder.conditions.moment.empty",
            i18n.conditions.moment.empty,
          );
        },
        isInputValid: function () {
          return true;
      ...
      "!null": {
        conditionName: function (dt, i18n) {
          return dt.i18n(
            "searchBuilder.conditions.moment.notEmpty",
            i18n.conditions.moment.notEmpty,
          );
        },
        isInputValid: function () {
          return true;
    ...
    Criteria.stringConditions = {
      ...
      contains: {
        ...
        search: function (value, comparison) {
          return (
            value.toLowerCase().indexOf(comparison[0].toLowerCase()) !== -1
          );
        },
      },
      ends: {
  ...
  var Group = /** @class */ (function () {
    ...
    Group.prototype.redrawContents = function () {
      ...
      for (var i = 0; i < this.s.criteria.length; i++) {
        ...
        if (crit instanceof Criteria) {
          ...
          // Add to the group
          $$1(this.s.criteria[i].criteria.dom.container).insertBefore(
            this.dom.add,
          );
    ...
    Group.prototype.setupLogic = function () {
      ...
      // Set criteria left margin
      $$1(this.dom.container).css(
        "margin-left",
        $$1(this.dom.logicContainer).outerHeight(true),
      );
    ...
    Group.prototype.addCriteria = function (crit, redraw) {
      ...
      for (var i = 0; i < this.s.criteria.length; i++) {
        if (i === 0 && this.s.criteria[i].criteria.s.index > criteria.s.index) {
          ...
          $$1(criteria.getNode()).insertBefore(
          ...
          $$1(criteria.getNode()).insertAfter(
            this.s.criteria[i].criteria.dom.container,
          );
          inserted = true;
        }
  ...
  var SearchBuilder = /** @class */ (function () {
    function SearchBuilder(builderSettings, opts) {
      ...
      this.dom = {
        ...
        title: $$2("<div/>").addClass(this.classes.title),
        titleRow: $$2("<div/>").addClass(this.classes.titleRow),
        topGroup: undefined,
      };
      this.s = {
        dt: table,
    ...
    SearchBuilder.prototype._applyPreDefDefaults = function (preDef) {
      ...
      var _loop_1 = function (crit) {
        ...
        if (crit.criteria !== undefined) {
          ...
          this_1.s.dt.columns().every(function (index) {
            if (
              _this.s.dt.settings()[0].aoColumns[index].sTitle === crit.data
            ) {
              crit.dataIdx = index;
            }
          });
    ...
    SearchBuilder.prototype._build = function () {
      ...
      $$2.fn.DataTable.Api.registerPlural(
        "columns().type()",
        "column().type()",
    ...
    SearchBuilder.prototype._filterChanged = function (count) {
      ...
      if (typeof fn === "function") {
        fn(
          count,
          this.s.dt.i18n("searchBuilder.button", this.c.i18n.button, count),
        );
      }
    };
    /**
