  ...
  $.extend(AutoFill.prototype, {
    ...
    _getPosition: function (node, targetParent) {
      ...
      do {
        ...
        top +=
          positionTop + parseInt(currOffsetParent.css("border-top-width")) * 1;
        left +=
          positionLeft +
          parseInt(currOffsetParent.css("border-left-width")) * 1;
        ...
        selected.push(
          $.map(columns, function (column) {
            ...
            if (editField !== undefined) {
              data = dtSettings.oApi._fnGetObjectDataFn(editField)(
    ...
    _shiftScroll: function (e) {
      ...
      if (scroll.dtLeft !== null && e.pageX < scroll.dtLeft + buffer) {
        ...
        scroll.dtLeft !== null &&
        e.pageX > scroll.dtLeft + scroll.dtWidth - buffer
      ) {
        dtHoriz = scrollSpeed;
      }
    ...
    _update: function (result, cells) {
      ...
      var update =
        this.c.update !== null ? this.c.update : this.c.editor ? false : true;
  ...
  AutoFill.actions = {
    ...
    fill: {
      ...
      option: function (dt, cells) {
        return dt.i18n(
          "autoFill.fill",
          "Fill all cells with <i>" + cells[0][0].label + "</i>",
        );
      },
