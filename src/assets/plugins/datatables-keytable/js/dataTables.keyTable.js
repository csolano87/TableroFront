...
(function (factory) {
  ...
  $.extend(KeyTable.prototype, {
    ...
    _tabInput: function () {
      ...
      var dt = this.s.dt;
      var tabIndex =
        this.c.tabIndex !== null ? this.c.tabIndex : dt.settings()[0].iTabIndex;
      ...
      if (!this.s.tabInput) {
        var div = $(
          '<div><input type="text" tabindex="' + tabIndex + '"/></div>',
        ).css({
          position: "absolute",
          height: 1,
          width: 0,
    ...
    _updateFixedColumns: function (column) {
      ...
      if (settings._oFixedColumns) {
        ...
        var rightCols =
          settings.aoColumns.length - settings._oFixedColumns.s.iRightColumns;
