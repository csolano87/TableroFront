...
(function (d) {
  ...
  d.extend(h.prototype, {
    ...
    _modeChange: function (a, b, e) {
      var c = this.dom[b],
        f = this.s.position,
        g = function (a) {
          c.floating.attr("style", function (b, c) {
            return (c || "") + "width: " + a + "px !important;";
          });
        },
        i = this.dom["footer" === b ? "tfoot" : "thead"],
        h = d.contains(i[0], j.activeElement) ? j.activeElement : null;
      h && h.blur();
      if ("in-place" === a) {
        if (
          (c.placeholder && (c.placeholder.remove(), (c.placeholder = null)),
          this._unsize(b),
          "header" === b ? c.host.prepend(i) : c.host.append(i),
          c.floating)
        )
  ...
  d.fn.DataTable.FixedHeader = h;
  d(j).on("init.dt.dtfh", function (a, b) {
    if ("dt" === a.namespace) {
      var e = b.oInit.fixedHeader,
        c = i.defaults.fixedHeader;
  ...
  i.Api.register("fixedHeader.enable()", function (a) {
  ...
  d.each(["header", "footer"], function (a, b) {
    i.Api.register("fixedHeader." + b + "Offset()", function (a) {
      var c = this.context;
      return a === k
