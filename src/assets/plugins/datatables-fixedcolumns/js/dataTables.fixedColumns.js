  ...
  $.extend(FixedColumns.prototype, {
    ...
    fnToFixedNode: function (rowIdx, colIdx) {
      ...
      if (colIdx < this.s.iLeftColumns) {
        found = $(this.dom.clone.left.body).find(
          "[data-dt-row=" + rowIdx + "][data-dt-column=" + colIdx + "]",
        );
      } else if (colIdx >= this.s.iRightColumns) {
        found = $(this.dom.clone.right.body).find(
          "[data-dt-row=" + rowIdx + "][data-dt-column=" + colIdx + "]",
        );
      }
    ...
    _fnConstruct: function (oInit) {
      ...
      jqTable
        ...
        .on(
          ...
          function (e, settings, column, vis, recalc) {
      ...
      $.each(this.s.dt.aoColumns, function (i, col) {
        ...
        if (!th.filter(":visible").length) {
          ...
          if (that.s.aiOuterWidths.length === 0) {
            ...
            iWidth +=
              typeof border === "string" && border.indexOf("px") === -1
                ? 1
                : parseInt(border, 10);
          }
    ...
    _firefoxScrollError: function () {
      if (_firefoxScroll === undefined) {
        ...
        _firefoxScroll =
          test[0].clientWidth === test[0].offsetWidth &&
          this._fnDTOverflow().bar !== 0;
